  ...
  <div className="ProfileHeader">
    <div className="ProfileHeader__user-info">
      <div className="ProfileHeader__profile-photo">
        <img
          src="https://scontent.fpap1-1.fna.fbcdn.net/v/t1.0-1/p320x320/28795827_2092538017736253_5661042761877422080_n.jpg?_nc_cat=0&oh=702aa6b49c1b7e7e120d4d80680a01fb&oe=5B8E8996"
          alt="profile"
        />
